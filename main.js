...
let paidTodayLimit = document.querySelector(".progress .inner .number span.down");
...
let changePaidTodayCancel = document.querySelector(".change-limit-form .cancel");
...
if(localStorage.getItem("paid-Today-Date")) {
    ...
    if(localStorage.getItem("paid-Today-Date") != paidTodayChecker.getDate()) {
        ...
        localStorage.setItem("paid-today", localStorage.getItem("paid-today-limit"));
...
function editCircle() {
    if(localStorage.getItem("paid-today") < 0) {
        ...
        circle.style["stroke-dashoffset"] = 472 - 472 * localStorage.getItem("paid-today") / localStorage.getItem("paid-today-limit") + 15;
    }
}
