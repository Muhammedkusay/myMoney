...
// reset every thing
let resetBtn = document.querySelector("header nav");
let resetForm = document.querySelector("header .reset-form");
let resetDoneBtn = document.querySelector("header .reset-form .done");
let resetCancelBtn = document.querySelector("header .reset-form .cancel");
